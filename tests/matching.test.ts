...
test('block number does not affect LITE-03A1 matching',()=>assert.deepEqual(calculateMatch(requirement,{...property,blockNumber:1}),calculateMatch(requirement,{...property,blockNumber:12})));
