...
export default function RequirementForm(){
  ...
  return <SafeAreaView style={styles.page} edges={['top']}><AppHeader title={id?t('editRequirement'):t('addRequirement')}/><KeyboardAwareScrollViewCompat contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
    ...
    <FormField testID="requirement-notes" label={t('extraConditions')} value={notes} multiline onChangeText={setNotes}/><PrimaryButton testID="requirement-save-match" title={t('saveAndMatch')} onPress={()=>persist(true)}/><PrimaryButton testID="requirement-save" title={t('saveOnly')} onPress={()=>persist(false)} color={colors.green}/>
